    ...
    <form onSubmit={handleSubmit(onSubmit)}>
        <div className="w-[100%] h-[100vh] bg-no-repeat bg-cover flex justify-center items-center bg-[url('https://static.fullstack.edu.vn/static/media/f8-og-image.7bfad51d2684a4d093a4.jpg')]">
          <div className="w-[100%] h-[100%] text-center backdrop-blur-sm pt-[100px]">
            ...
            <input className='border-2 p-[10px] m-[10px] rounded indent-[10px] w-[500px]' type="text" placeholder='Tên' {...register('name')} /> <br />
            <input className='border-2 p-[10px] m-[10px] rounded indent-[10px] w-[500px]' type="email" placeholder='Email' {...register('email')} /> <br />
            <input className='border-2 p-[10px] m-[10px] rounded indent-[10px] w-[500px]' type="password" placeholder='Mật khẩu' {...register('password')} /> <br />
