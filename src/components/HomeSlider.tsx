...
const HomeSlider = (props: Props) => {
  ...
  return (
    <div id="light-slider" className='h-[270px]'>
        <div className='flex justify-between w-[100%] h-[100%] bg-gradient-to-r from-[#7612ff] to-[#05b2ff] rounded-xl p-[10px]'>
        ...
        <div className='flex justify-between w-[100%] h-[100%] bg-gradient-to-r from-[#fe215e] to-[#ff9402] rounded-xl p-[10px]'>
        <div className="py-[50px] pl-[40px]">
        ...
        <div className='flex justify-between w-[100%] h-[100%] bg-gradient-to-r from-[#007efe] to-[#06c3fe] rounded-xl p-[10px]'>
        <div className="py-[50px] pl-[40px]">
        ...
        <div className='flex justify-between w-[100%] h-[100%] bg-gradient-to-r from-[#2877fa] to-[#6717cd] rounded-xl p-[10px]'>
        <div className="py-[50px] pl-[40px]">
