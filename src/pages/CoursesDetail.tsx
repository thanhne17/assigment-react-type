        ...
        if (User.is_registered.includes(coure?.slug)) {
          return (
            <div className="mt-[20px]">
              <NavLink to={``} className='hover:bg-black duration-100 py-[10px] px-[30px] text-lg font-semibold text-white bg-[orange] rounded-3xl'>Tiếp tục học</NavLink>
            </div>
                  ...
                  return (
                    <div key={index}>
                      <div className="flex justify-between items-center border rounded-md px-[30px] py-[10px] bg-[#f5f5f5]">
                        <h1 className="font-semibold text-lg m-0">{index + 1}. {Element?.title}</h1>
